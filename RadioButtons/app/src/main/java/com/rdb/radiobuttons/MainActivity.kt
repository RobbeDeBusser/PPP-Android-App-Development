...
import com.rdb.radiobuttons.ui.theme.RadioButtonsTheme
...
fun RadioButtonsExample(modifier: Modifier = Modifier) {
    ...
    val radioText = listOf("Red", "Green", "Yellow")
    val colorList = arrayListOf(Color.Red, Color.Green, Color.Yellow)
        ...
        Column() {
            ...
            radioText.forEachIndexed { position, name ->
                ...
                Row(verticalAlignment = Alignment.CenterVertically, modifier = Modifier.clickable {
                    ...
                    RadioButton(
                        selected = name == radioText[radioIndex.value],
                        onClick = {
                            radioIndex.value = position
